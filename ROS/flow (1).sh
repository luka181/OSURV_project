...
#TODO prvo otvoriti terminal u (arm_and_chassis_ws) i upisati catkin_make, nakon toga otvoriti jos 4 terminala i u svakom ispisati komande.

# T1
roslaunch wc_main main.launch all_motors_sim:=true
# T2
roslaunch common_teleop routines_teleop.launch
# T3
roslaunch wc_teleop manual_teleop.launch
# T4
roslaunch wc_safety safety.launch

rostopic list
rostopic echo /wc/cmd
rostopic echo /wc/safe_cmd
